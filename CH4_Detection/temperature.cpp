...
void Temperature::closeEvent(QCloseEvent *event)
{
if(openflag)
{
        // bMutex.unlock();
...
{
    connect(ui->pushSendMaxY,&QPushButton::clicked,this,&Temperature::Set_MaxY_Range);
    connect(ui->pushSendMinY,&QPushButton::clicked,this,&Temperature::Set_MinY_Range);
    connect(ui->pushSendMaxX,&QPushButton::clicked,this,&Temperature::Set_MaxX_Range);
    connect(ui->pushSendMinX,&QPushButton::clicked,this,&Temperature::Set_MinX_Range);
}

void Temperature::draw_begin(){
...
void Temperature::Draw_Graph1()
{
 ...
 //   series2[1] = new QLineSeries;
  qDebug() <<"start:time7";
    ...
    series1[0] = new QLineSeries;
         qDebug() <<"start:time6";
    array_graph1 = new std::thread(&Temperature::draw_thread1, this);//创建画图线程
         qDebug() <<"start:time5";
    array_graph1->join();
 qDebug() <<"start:time4";
...
/*************功能：坐标轴手动设置**********************/
void Temperature::Set_MaxY_Range()
{
...
/*************功能：坐标轴手动设置**********************/
void Temperature::Set_MinY_Range()
{
...
/*************功能：坐标轴手动设置**********************/
void Temperature::Set_MaxX_Range()
{
...
/*************功能：坐标轴手动设置**********************/
void Temperature::Set_MinX_Range()
{
